...
CREATE TABLE CLIENTE_ENDERECO (
    ID_ENDERECO_CLIENTE NUMERIC PRIMARY KEY,
    MUNICIPIO VARCHAR,
    SG_UF VARCHAR,
    CEP VARCHAR,
    COMPLEMENTO VARCHAR,
...
CREATE TABLE TIPO_FUNCIONARIO (
    ID_TIPO_FUNCIONARIO NUMERIC PRIMARY KEY,
...
CREATE TABLE PET (
    ID_PET NUMERIC PRIMARY KEY,
    NM_PET VARCHAR,
    RACA VARCHAR,
    DT_NACIMENTO DATE,
    OBSERVACOES VARCHAR,
    ID_CLIENTE NUMERIC,
    ID_PET_ESPECIE NUMERIC
);

CREATE TABLE PET_ESPECIE (
    ID_PET_ESPECIE NUMERIC PRIMARY KEY,
    NM_PET_ESPECIE VARCHAR
);

CREATE TABLE TIPO_SERVICO (
    ID_TIPO_SERVICO NUMERIC PRIMARY KEY,
    NM_TIPO_SERVICO VARCHAR,
    ID_TIPO_FUNCIONARIO NUMERIC
);
...
CREATE TABLE SERVICO (
    DT_AGENDAMENTO DATE,
    HR_AGENDAMENTO TIME,
    ID_AGENDAMENTO NUMERIC PRIMARY KEY,
    ID_FUNCIONARIO_CADASTRADOR NUMERIC,
